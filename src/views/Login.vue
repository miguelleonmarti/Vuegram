      ...
      <div class="col2" :class="{ 'signup-form': !showLoginForm && !showForgotPassword }">
        ...
        <form v-if="showForgotPassword" @submit.prevent class="password-reset">
          <div v-if="!passwordResetSuccess">
            ...
            <input v-model.trim="passwordForm.email" type="text" placeholder="you@gmail.com" id="email3">
          ...
          <div v-else>
            <h1>Email Sent</h1>
            <p>check yuor email for a link to reset your password</p>
  ...
  methods: {
    ...
    login() {
      auth
        ...
        .then(user => {
          this.$store.commit("setCurrentUser", user.user); // TODO: it could not work -> user.user
          this.$store.dispatch("fetchUserProfile"); // TODO: understand
    ...
    resetPassword() {
      ...
      auth.sendPasswordResetEmail(this.passwordForm.email)
      .then(() => {
        this.performingRequest = false;
